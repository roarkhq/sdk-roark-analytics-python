...
from ..types.health_get_response import HealthGetResponse
...
class HealthResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> HealthResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/roark-analytics-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> HealthResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/roark-analytics-python#with_streaming_response
        """
