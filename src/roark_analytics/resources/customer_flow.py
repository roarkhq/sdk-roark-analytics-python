...
class CustomerFlowResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._put(
            path_template("/v1/customer-flow/{flow_id}", flow_id=flow_id),
            body=maybe_transform(
                {
                    "agent_expectations": agent_expectations,
                    "agent_ids": agent_ids,
    ...
    def replace_graph(
        ...
        *,
        ...
        if not flow_id:
            raise ValueError(f"Expected a non-empty value for `flow_id` but received {flow_id!r}")
        return self._put(
            path_template("/v1/customer-flow/{flow_id}/graph", flow_id=flow_id),
            body=maybe_transform(
                {
                    "graph": graph,
    ...
    def update_happy_path(
        ...
        *,
        ...
        if not flow_id:
            raise ValueError(f"Expected a non-empty value for `flow_id` but received {flow_id!r}")
        return self._put(
            path_template("/v1/customer-flow/{flow_id}/happy-path", flow_id=flow_id),
            body=maybe_transform(
                {
