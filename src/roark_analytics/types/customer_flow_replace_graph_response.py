...
__all__ = [
    ...
    "Data",
    "ImprovFlowVariant",
    "ImprovFlowVariantHandoffPersona",
    "ScriptedFlowVariant",
...
class ImprovFlowVariantHandoffPersona(BaseModel):
    id: str
    """Unique identifier of the persona"""
...
class ImprovFlowVariant(BaseModel):
    ...
    handoff_personas: List[ImprovFlowVariantHandoffPersona] = FieldInfo(alias="handoffPersonas")
    """
...
class Data(BaseModel):
    edge_cases: List[Union[ScriptedFlowVariant, ImprovFlowVariant, VoicemailFlowVariant]] = FieldInfo(alias="edgeCases")
    """The edge cases after the write."""

    graph: List[FlowStep]

    happy_path: Optional[Union[ScriptedFlowVariant, ImprovFlowVariant, VoicemailFlowVariant]] = FieldInfo(
        alias="happyPath"
    )
    """The happy path after the write."""
