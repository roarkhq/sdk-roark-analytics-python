...
class RunSimulationFromConfigPlanFlow(TypedDict, total=False):
    ...
    edge_cases: Annotated[
        Union[Literal["ALL"], Iterable[RunSimulationFromConfigPlanFlowEdgeCaseUnionMember1]],
...
class RunSimulationFromConfigVariableUnionMember1(TypedDict, total=False):
...
class RunSimulationFromConfigVariableUnionMember2(TypedDict, total=False):
...
class RunSimulationFromConfig(TypedDict, total=False):
    """
    Describe a simulation and run it, optionally keeping the configuration as a
    reusable plan.
    """
    ...
    variables: Union[
        Dict[str, str],
        Iterable[RunSimulationFromConfigVariableUnionMember1],
        Iterable[RunSimulationFromConfigVariableUnionMember2],
    ]
    """
...
class RunSimulationFromPlanID(TypedDict, total=False):
    """Run a plan that already exists."""
