...
class Data(BaseModel):
    ...
    """Whether that plan is listed by GET /v1/simulation/plan.

    False for an unsaved run, whose plan is hidden.
    """
    ...
    PENDING normally, or QUEUED when the plan runs sequentially and another job of
    its is still active.
    """
