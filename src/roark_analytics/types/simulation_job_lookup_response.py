...
__all__ = ["SimulationJobLookupResponse", "Data", "DataAgentEndpoint", "DataPersona", "DataScenario"]
...
class DataAgentEndpoint(BaseModel):
    ...
    type: Literal["PHONE", "WEBSOCKET", "LIVEKIT", "SMALL_WEBRTC", "ELEVENLABS_WS"]
    """Agent endpoint type"""
...
class SimulationJobLookupResponse(BaseModel):
    data: Data
    """Simulation job with related entities"""
