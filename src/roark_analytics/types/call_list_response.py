...
class Data(BaseModel):
    ...
    """Indicates the status of `recordingUrl`.

    `AVAILABLE`: signed URL returned. `NOT_AVAILABLE`: no recording on file yet
    (e.g. still processing). `RESTRICTED`: the calling API key does not have the
    `recording:read` permission and the URL has been withheld.
    """
