...
from roark_analytics.types.evaluation_create_job_params import EvaluationCreateJobParams
...
class TestRoark:
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = Roark(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        ...
        with pytest.raises(APITimeoutError):
            self.client.post(
                "/v1/evaluation/job",
                body=cast(object, maybe_transform(dict(evaluators=["string"]), EvaluationCreateJobParams)),
...
class TestAsyncRoark:
    ...
    def test_base_url_trailing_slash(self, client: AsyncRoark) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncRoark) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncRoark) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = AsyncRoark(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
