...
- <code title="get /v1/simulation/plan/jobs">client.simulation.<a href="./src/roark_analytics/resources/simulation.py">list_run_plan_jobs</a>(\*\*<a href="src/roark_analytics/types/simulation_list_run_plan_jobs_params.py">params</a>) -> <a href="./src/roark_analytics/types/simulation_list_run_plan_jobs_response.py">SimulationListRunPlanJobsResponse</a></code>
